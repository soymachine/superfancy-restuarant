...
const ScrollExpandHero = ({
  ...
  useEffect(() => {
    const handleWheel = (e: globalThis.WheelEvent) => {
      ...
      if (mediaFullyExpanded && e.deltaY < 0 && isAtTop) {
        setMediaFullyExpanded(false);
        e.preventDefault();
    ...
    const handleTouchMove = (e: globalThis.TouchEvent) => {
      ...
      if (mediaFullyExpanded && deltaY < -20 && isAtTop) {
        setMediaFullyExpanded(false);
        e.preventDefault();
      } else if (!mediaFullyExpanded && isAtTop) {
        e.preventDefault();
            ...
            <div className="flex flex-col items-center justify-center w-full h-[100dvh] relative">
              ...
              >
                ...
                <div className="flex flex-col items-center text-center relative z-10 mt-4 transition-none">
                  {date && (
                    <p
                      className="text-2xl text-gold-200 font-serif"
                  ...
                  {scrollToExpand && (
                    <p
                      className="text-gold-200 font-medium text-center text-sm tracking-widest uppercase"
                      style={{ transform: `translateX(${textTranslateX}vw)` }}
                    >
                      {scrollToExpand}
                    </p>
